"""
Exponential Spring Mass-Spring Lattice Simulation with Immovable Backplate

This script implements a 2D mass-spring lattice system with exponential spring models
and an immovable backplate to the right of the lattice.
The system includes:
...
save_animation_to_file("animations/lattice_anim_with_backplate.mp4");

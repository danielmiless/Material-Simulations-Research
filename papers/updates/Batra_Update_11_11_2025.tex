...
\noindent To model such systems, we implement column-based material scaling where each column (from left to right) has material properties scaled by a multiplicative factor relative to the base column.
...
\noindent The implementation uses lookup functions:
